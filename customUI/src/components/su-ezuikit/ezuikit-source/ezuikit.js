...
(function(global, factory) {
  ...
  var EZUIKitPlayer = function EZUIKitPlayer(params) {
    ...
    if (params.id) {
      ...
      this.opt.parentNodeId = `${params.id}ParentNode`
      this.opt.parentNode = $(`#${this.opt.parentNodeId}`)
    }
    ...
    addJs(jqueryJS, function() {
      addJs(layerJs, function() {
        ...
        if (matchHeaderOpt().headerContainer) {
          ...
          // 顶部的自定义区域
          let headerTitleDOM = document.createElement('div')
          headerTitleDOM.setAttribute('class', 'su-header-title')
          headerTitleDOM.setAttribute('id', `headerTitle-${_this.opt.id}`)
          headerTitleDOM.innerHTML = params.title
          headerContainer.appendChild(headerTitleDOM)
          // if(params.headerTitleCallBack) {
          //   params.headerTitleCallBack()
          // }

          var controsDOM = document.createElement('div')
          controsDOM.setAttribute('class', 'contros')
          controsDOM.setAttribute('id', `controls-${_this.opt.id}`)
          headerContainer.appendChild(controsDOM)
          domElement.insertBefore(headerContainer, iframe)

          // let controlsCustomDOM = document.createElement('span')
          // controlsCustomDOM.setAttribute('id', `customControls-${_this.opt.id}`)
          // controlsCustomDOM.setAttribute('class', 'su-custom-controls')
          // controsDOM.appendChild(controlsCustomDOM)
          if (params.customControlsCallBack) params.customControlsCallBack()

          // 截图
          if (matchHeaderOpt().capturePictureModule) {
            let capturePictureDOM = document.createElement('span')
            capturePictureDOM.setAttribute('id', 'capturePicture')
            capturePictureDOM.setAttribute('class', 'capture-picture')
            capturePictureDOM.setAttribute('title', '截图')
            ...
            capturePictureDOM.innerHTML = '<svg t="1637464927459" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8162" width="24" height="24"><path d="M864 248H728l-32.4-90.8C691 144.5 679 136 665.4 136H358.6c-13.5 0-25.6 8.5-30.1 21.2L296 248H160c-44.2 0-80 35.8-80 80v456c0 44.2 35.8 80 80 80h704c44.2 0 80-35.8 80-80V328c0-44.2-35.8-80-80-80z m8 536c0 4.4-3.6 8-8 8H160c-4.4 0-8-3.6-8-8V328c0-4.4 3.6-8 8-8h186.7l17.1-47.8 22.9-64.2h250.5l22.9 64.2 17.1 47.8H864c4.4 0 8 3.6 8 8v456z" p-id="8163" fill="#ffffff"></path><path d="M512 384c-88.4 0-160 71.6-160 160s71.6 160 160 160 160-71.6 160-160-71.6-160-160-160z m0 256c-53 0-96-43-96-96s43-96 96-96 96 43 96 96-43 96-96 96z" p-id="8164" fill="#ffffff"></path></svg>'
          ...
          if (matchHeaderOpt().saveModule) {
            ...
            startSaveDOM.setAttribute('id', 'startSave')
            startSaveDOM.setAttribute('class', 'start-save')
            startSaveDOM.setAttribute('title', '开始录像')
            ...
            startSaveDOM.innerHTML = '<svg t="1637464964291" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8422" width="24" height="24"><path d="M912 302.3L784 376V224c0-35.3-28.7-64-64-64H128c-35.3 0-64 28.7-64 64v576c0 35.3 28.7 64 64 64h592c35.3 0 64-28.7 64-64V648l128 73.7c21.3 12.3 48-3.1 48-27.6V330c0-24.6-26.7-40-48-27.7zM712 792H136V232h576v560z m176-167l-104-59.8V458.9L888 399v226z" p-id="8423" fill="#ffffff"></path><path d="M208 360h112c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H208c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8z" p-id="8424" fill="#ffffff"></path></svg>'
            startSaveDOM.onclick = function() {
              _this.startSave()
              _this.opt.parentNode.find('#startSave').attr('class', 'icon hide')
              _this.opt.parentNode.find('#stopSave').attr('class', 'icon')
            }
            controsDOM.appendChild(startSaveDOM)

            // 结束录像 - 默认不显示
            let stopSaveDOM = document.createElement('span')
            stopSaveDOM.setAttribute('id', 'stopSave')
            stopSaveDOM.setAttribute('class', 'stop-save hide')
            stopSaveDOM.setAttribute('title', '结束录像')
            ...
            stopSaveDOM.innerHTML = '<svg t="1637464964291" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8422" width="24" height="24"><path d="M912 302.3L784 376V224c0-35.3-28.7-64-64-64H128c-35.3 0-64 28.7-64 64v576c0 35.3 28.7 64 64 64h592c35.3 0 64-28.7 64-64V648l128 73.7c21.3 12.3 48-3.1 48-27.6V330c0-24.6-26.7-40-48-27.7zM712 792H136V232h576v560z m176-167l-104-59.8V458.9L888 399v226z" p-id="8423" fill="#d81e06"></path><path d="M208 360h112c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H208c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8z" p-id="8424" fill="#d81e06"></path></svg>'
            stopSaveDOM.onclick = function() {
              _this.stopSave()
              _this.opt.parentNode.find('#stopSave').attr('class', 'icon hide')
              _this.opt.parentNode.find('#startSave').attr('class', 'icon')
            }
          ...
          if (matchHeaderOpt().zoomModule) {
            ...
            enableZoomDOM.setAttribute('id', 'enableZoom')
            enableZoomDOM.setAttribute('class', 'enable-zoom')
            enableZoomDOM.setAttribute('title', '开启电子放大')
            enableZoomDOM.innerHTML = '<svg id="enableZoom" t="1578882639834" class="icon" viewBox="0 0 1000 1000" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2227" width="24" height="24"><path d="M830.6119 441.1089c0-193.7756-157.0939-350.8641-350.8775-350.8641S128.8559 247.3333 128.8559 441.1089 285.9508 791.972 479.7344 791.972 830.6119 634.8845 830.6119 441.1089zM483.2821 710.4863c-146.7975 0-265.8187-118.9953-265.8187-265.8088S336.4847 178.8697 483.2821 178.8697s265.8197 118.9953 265.8197 265.8078S630.0796 710.4863 483.2821 710.4863zM770.6031 653.5739l-72.6417 75.9485 141.6917 160.1814 82.0737-90.0739L770.6031 653.5739zM527.5849 267.4727h-88.60655762279428v132.90489048425167H306.0690340253259v88.60292721534799h132.90933675248866v132.9038911617923h88.60655762279428V488.9794719180395h132.90933675248866v-88.60292721534799H527.5849284006089V267.4726535408993z" p-id="2228" fill="#ffffff"></path></svg>'
            enableZoomDOM.onclick = function() {
              _this.enableZoom()
              _this.opt.parentNode.find('#enableZoom').attr('class', 'icon hide')
              _this.opt.parentNode.find('#closeZoom').attr('class', 'icon')
            }
            controsDOM.appendChild(enableZoomDOM)

            // 关闭放大 - 默认不显示
            let closeZoomDOM = document.createElement('span')
            closeZoomDOM.setAttribute('id', 'closeZoom')
            closeZoomDOM.setAttribute('class', 'close-zoom hide')
            closeZoomDOM.setAttribute('title', '关闭电子放大')
            closeZoomDOM.innerHTML = '<svg id="closeZoom" t="1578882639834" class="icon" viewBox="0 0 1000 1000" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2227" width="24" height="24"> <path d="M830.6119 441.1089c0-193.7756-157.0939-350.8641-350.8775-350.8641S128.8559 247.3333 128.8559 441.1089 285.9508 791.972 479.7344 791.972 830.6119 634.8845 830.6119 441.1089zM483.2821 710.4863c-146.7975 0-265.8187-118.9953-265.8187-265.8088S336.4847 178.8697 483.2821 178.8697s265.8197 118.9953 265.8197 265.8078S630.0796 710.4863 483.2821 710.4863zM770.6031 653.5739l-72.6417 75.9485 141.6917 160.1814 82.0737-90.0739L770.6031 653.5739zM527.5849 267.4727h-88.60655762279428v132.90489048425167H306.0690340253259v88.60292721534799h132.90933675248866v132.9038911617923h88.60655762279428V488.9794719180395h132.90933675248866v-88.60292721534799H527.5849284006089V267.4726535408993z" p-id="2228" fill="red"></path></svg>'
            closeZoomDOM.onclick = function() {
              _this.closeZoom()
              _this.opt.parentNode.find('#closeZoom').attr('class', 'icon hide')
              _this.opt.parentNode.find('#enableZoom').attr('class', 'icon')
            }
        ...
        if (matchFooterOpt().footerContainer || _this.opt.plugin.indexOf('talk') !== -1) {
          ...
          if (matchFooterOpt().footerContainer) {
            ...
            footerLeftContainer.setAttribute('class', 'su-left-audio-controls')
            footerContainer.appendChild(footerLeftContainer)

            // 左边的内容自定义区域
            let footerLeftCustomContainer = document.createElement('div')
            footerLeftCustomContainer.setAttribute('id', `bottomCustomArea-${_this.opt.id}`)
            footerLeftContainer.appendChild(footerLeftCustomContainer)
            if (params.footerLeftCustomCallBack) {
              params.footerLeftCustomCallBack()
            }
            ...
            if (matchFooterOpt().talkModule) {
              ...
              footerLeftContainer.appendChild(startTalkDOM)
              footerLeftContainer.appendChild(stopTalkDOM)
            }
            ...
            if (matchFooterOpt().broadcastModule) {
              ...
              footerLeftContainer.appendChild(startBroadcastDOM)
              footerLeftContainer.appendChild(stopBroadcastDOM) // 召唤自定义语言

              _this.opt.parentNode.find('#voice-custom').onclick = function() {
                console.log('显示自定义语音')
              ...
              function randerVoliceList(data) {
                ...
                if (data && data.length > 0) {
                  for (var i = 0; i < data.length; i++) {
                    ...
                    console.log(document.getElementsByClassName('voice-list-ul'), 'document.getElementsByClassName(\'voice-list-ul\')')
                    _this.opt.parentNode.find('.voice-list-ul')[0].append(voiceItem)
                    // "<li class='voice-item' id='voice-item-" + i + "' data-time=" + (data[i]["duration"] || 20) + " data-url=" + data[i]["fileUrl"] + ">" + (data[i]["voiceName"].length > 10 ? (data[i]["voiceName"].substr(0, 10) + "...") : data[i]["voiceName"]) + "</li>";
                  ...
                  if (data.length === EZUIKit.state.pageSize) {
                    _this.opt.parentNode.find('#voice-list-end').html('向下滚动加载更多')
                  } else {
                    _this.opt.parentNode.find('#voice-list-end').html('没有更多数据了')
                  }
                }
              }
              ...
              footerLeftContainer.appendChild(startSpeakDOM)
              footerLeftContainer.appendChild(stopSpeakDOM)

              _this.opt.parentNode.find('#voice-list').scroll(function(e) {
              ...
              timeAreaDOM.setAttribute('class', 'time-area hide')
              timeAreaDOM.setAttribute('id', 'time-area')
              timeAreaDOM.innerHTML = '00:00'
              footerLeftContainer.appendChild(timeAreaDOM) // 按住说话

              var recorder
              _this.opt.parentNode.find('#startSpeak').mousedown(function() {
                if (EZUIKit.state.countTimer) {
                  window.layer.msg('语音设备正忙，请稍后重试')
                  return false
                }
              ...
              _this.opt.parentNode.find('#stopSpeak').mouseup(function() {
                console.log('松开发送')
                stopSpeakDOM.setAttribute('class', 'speak on hide')
                stopSpeakFun()
            ...
            function countTime(type, start) {
              ...
              _this.opt.parentNode.find('#time-area').attr('class', 'time-area')

              if (type === 'add') {
                var i = start
                EZUIKit.state.countTimer = setInterval(function() {
                  ++i
                  _this.opt.parentNode.find('#time-area').html(formatSeconds(i))
                }, 1000)
              } else if (type === 'sub') {
                var i = start
                EZUIKit.state.countTimer = setInterval(function() {
                ...
                clearInterval(EZUIKit.state.countTimer)
                EZUIKit.state.countTimer = undefined
                _this.opt.parentNode.find('#time-area').attr('class', 'time-area hide')
                _this.opt.parentNode.find('#time-area').html('00:00')
