  ...
  <div class='image-preview-bg' ref='bg' :style='layoutStyle' id='imgcontent'>
    ...
    <div class='toolBox' v-if='!moving'>
      <div class='btn-wrapper'>
        ...
        <su-preview-popup content='原图比例'>
          <div class='Proportion' @click='handleProportion'>
            1:1
          </div>
        </su-preview-popup>
        <div class='scaleBox'>
          <su-preview-popup content='缩小'>
            <div @click='handleScale(-1)'>
              ...
              <!--              <img :src='iconsrc.scales' />-->
            </div>
          </su-preview-popup>
          <div class='precentbox'>{{ scalePrecent }}%</div>
          <su-preview-popup content='放大'>
            <div @click='handleScale(1)'>
              ...
              <!--              <img :src='iconsrc.scaleb' />-->
            </div>
          </su-preview-popup>
        </div>
        <su-preview-popup content='全屏'>
        ...
        <su-preview-popup content='拉伸'>
          <div @click='handleStretched'>
            ...
            <!--            <img :src='iconsrc.stretched' />-->
          </div>
        </su-preview-popup>
        <div class='boxvertical' />
        <su-preview-popup content='旋转'>
          <div @click='rotateImg'>
...
import SuPreviewPopup from './su-preview-popup'

export default {
  name: 'su-preview-image',
  components: {
    SuPreviewPopup,
  },
  props: {
