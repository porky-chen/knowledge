      ...
      <div class="container">
        <h1>
          <router-link :to="`/info`">
            <!-- logo -->
            <slot>
              <el-row type="flex" align="middle" class="nav-logo">
                <i style="color:#5cb6ff;font-size:43px" class="el-icon-s-help"></i>
                <p style="color:#5cb6ff;margin:0 0 0 15px;font-size:30px;font-family:fantasy">Sunrt UI</p>
              </el-row>
            </slot>
        ...
        <ul class="nav">
          ...
          <li class="nav-item nav-item-theme">
            <router-link active-class="active" :to="`/theme`">主题
            </router-link>
          </li>
