  ...
  <div>
    <div class="banner">
      <div class="banner-desc">
        <h1>基于element网站快速成型工具</h1>
        <p>sunrtui，瀚阳轨道科技的前端通用组件库，基于element ui 二次封装</p>
      </div>
    </div>
    ...
    <div class="cards">
      <ul style="display:flex; justify-content: space-around;" class="container">
        <li>
          <div class="card">
            <img src="../../assets/images/guide.png" alt="">
            <h3>指南</h3>
            <p>了解设计指南，帮助产品设计人员搭建逻辑清晰、结构合理且高效易用的产品。</p>
            <router-link active-class="active" to="/guide/design" exact>查看详情
            </router-link>
          </div>
        </li>
        <li>
        ...
        <li>
          <div class="card">
            ...
            <router-link active-class="active" to="/theme" exact>查看详情
            </router-link>
          </div>
        </li>
      </ul>
